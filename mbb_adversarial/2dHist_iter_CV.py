...
for num in nums:
    ...
    df_odd = pd.read_csv('adv_results/odd_batch_'+ str(iter) +'_'+str(lam)+'.csv', index_col=0)
    df_even = pd.read_csv('adv_results/even_batch_'+ str(iter) +'_'+str(lam)+'.csv', index_col=0)
