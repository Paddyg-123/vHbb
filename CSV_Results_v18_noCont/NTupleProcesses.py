...
df_2jet = df_2jet.drop(['RunNumber', 'nTrackJets', 'TruthMET', 'TruthMETX', 'TruthMETY', 'jetnumbertruth20', 'jetnumbertruth30', 'Aplanarity', 'Sphericity', 'Centrality', 'Planarity', 'Var_C', 'Var_D', 'HTXS_Higgs_pt', 'HTXS_Higgs_eta', 'HTXS_Higgs_m', 'HTXS_V_pt', 'HTXS_V_eta', 'HTXS_V_phi', 'HTXS_V_m', 'HTXS_prodMode', 'HTXS_Stage0_Category', 'HTXS_Stage1_Category_pTjet25', 'HTXS_Stage1_Category_pTjet30', 'HTXS_Njets_pTjet25', 'HTXS_Njets_pTjet30', "dEtaBB", "dPhiBB", "weight", "dEtaWH", "dPhiLMET", "BDT", "pTL", "etaL", "sumPt", "ChannelNumber", "isOdd", "nSigJet", "nForwardJet", "pTBB", "pTBBoverMET", "etaB1", "etaB2", "dEtaBB", "HT", "METHT",'MV1cJ3' , "MPT", "etaJ3", "dRB1J3", "dRB2J3", "dPhiMETMPT", "dPhiMETdijet", "mindPhi", "dEtaWH", "dPhiLMET", 'mBBJ', 'pTJ3',"DSID","J1_Flav","J2_Flav","MV1cB1_cont", "MV1cB2_cont", "MV1cJ3_cont"], axis=1)

df_3jet = df_3jet.drop(['RunNumber', 'nTrackJets', 'TruthMET', 'TruthMETX', 'TruthMETY', 'jetnumbertruth20', 'jetnumbertruth30', 'Aplanarity', 'Sphericity', 'Centrality', 'Planarity', 'Var_C', 'Var_D', 'HTXS_Higgs_pt', 'HTXS_Higgs_eta', 'HTXS_Higgs_m', 'HTXS_V_pt', 'HTXS_V_eta', 'HTXS_V_phi', 'HTXS_V_m', 'HTXS_prodMode', 'HTXS_Stage0_Category', 'HTXS_Stage1_Category_pTjet25', 'HTXS_Stage1_Category_pTjet30', 'HTXS_Njets_pTjet25', 'HTXS_Njets_pTjet30', "dEtaBB", "dPhiBB", "weight", "dEtaWH", "dPhiLMET", "BDT", "pTL", "etaL", "sumPt", "ChannelNumber", "isOdd", "nSigJet", "nForwardJet", "pTBB", "pTBBoverMET", "etaB1", "etaB2", "dEtaBB", "HT", "METHT", "MPT", "etaJ3", "dRB1J3", "dRB2J3", "dPhiMETMPT", "dPhiMETdijet", "mindPhi", "dEtaWH", "dPhiLMET","DSID","J1_Flav","J2_Flav","MV1cB1_cont", "MV1cB2_cont", "MV1cJ3_cont"], axis=1)
...
if True == True:
    df_2jet_even.to_csv(path_or_buf='VHbb_data_2jet_even.csv')
    df_3jet_even.to_csv(path_or_buf='VHbb_data_3jet_even.csv')
    df_2jet_odd.to_csv(path_or_buf='VHbb_data_2jet_odd.csv')
    df_3jet_odd.to_csv(path_or_buf='VHbb_data_3jet_odd.csv')
else:
