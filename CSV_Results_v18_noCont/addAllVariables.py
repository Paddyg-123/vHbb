...
def main():
    folds = ['2jet_even', '2jet_odd', '3jet_even', '3jet_odd','2jet_full','3jet_full']
    for fold in folds:
        # Load in the NTuple CSVs as DataFrames.
        data = pd.read_csv('VHbb_data_'+fold+'.csv', index_col=0)
        ...
        data.to_csv(path_or_buf='allVariables_'+fold+'.csv')
