...
def main():
    ...
    sig_perc = round(100*sum(df_cut['EventWeight']*df_cut['Class'])/total_sig,2)
    back_perc = round(100*sum(df_cut['EventWeight']*(1-df_cut['Class']))/total_back,2)
    print "Cut = "+str(cut)+"; Signal Percentage = " + str(sig_perc) + "; Background Percentage = " + str(back_perc)
